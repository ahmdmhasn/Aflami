...
class MovieDetailsVC: BaseViewController {
    ...
    override func viewDidLoad() {
        ...
        likeButton.addTarget(self, action: #selector(likeButtonTapped(_:)), for: UIControlEvents.touchUpInside)
    ...
    func likeButtonTapped(_ button: LikeNavBarButton) {
        if button.isActive {
...
extension MovieDetailsVC: MovieDetailsDelegate {
    ...
    func updateMovieImage(path: String) {
        movieImage.sd_addActivityIndicator()
        movieImage.sd_setIndicatorStyle(.whiteLarge)
